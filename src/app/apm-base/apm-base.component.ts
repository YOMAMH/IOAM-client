...
@Component({
  selector: 'app-apm-base',
  templateUrl: './apm-base.component.html',
  styleUrls: ['./apm-base.component.css']
})
export class ApmBaseComponent implements OnInit {
  ...
  public actionUrl: string = "#/apm/base";
  ...
  constructor(private route: ActivatedRoute, private router: Router, private http: Http, private cdr: ChangeDetectorRef) {
    ...
    this.ApmBase.getHostInfo(this, "/apm/base");    // 获取产品线数据
    this.ApmBase.getOrderProdMaxRound(this,"tingyun_base");    // 应用变更频率top5
  }

  ngOnInit() {
    this.ApmBase.pagetion(this, "/apm/base");    // 分页
    this.ApmBase.handleCreateHost(this, "听云架构组", "/apm/creatBase");    // 创建应用
    this.ApmBase.handleDeleteHost(this, "/apm/dropBase");    // 删除主应用
    this.ApmBase.searchHost(this, "/apm/base");    // 模糊搜索
    this.ApmBase.updateProducts(this, "/apm/updateBase");    // 更新数据
