...
@Component({
  selector: 'app-apm-saas',
  templateUrl: './apm-saas.component.html',
  styleUrls: ['./apm-saas.component.css']
})
export class ApmSaasComponent {
  ...
  public actionUrl: string = "#/apm/saas";
  ...
  constructor(private route: ActivatedRoute, private router: Router, private http: Http, private cdr: ChangeDetectorRef) {
    ...
    this.ApmBase.getHostInfo(this, "/apm/saas");    // 获取产品线数据
    this.ApmBase.getOrderProdMaxRound(this,"tingyun_saas");    // 应用变更频率top5
  }

  ngOnInit() {
    this.ApmBase.pagetion(this, "/apm/saas");    // 分页
    this.ApmBase.handleCreateHost(this, "听云Saas", "/apm/creatSaas");    // 创建应用
    this.ApmBase.handleDeleteHost(this, "/apm/dropSaas");    // 删除主应用
    this.ApmBase.searchHost(this, "/apm/saas");    // 模糊搜索
    this.ApmBase.updateProducts(this, "/apm/updateSaas");    // 更新数据
