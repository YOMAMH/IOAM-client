...
@Component({
  selector: 'app-apm-common',
  templateUrl: './apm-common.component.html',
  styleUrls: ['./apm-common.component.css']
})
export class ApmCommonComponent {
  ...
  public actionUrl: string = "#/apm/common";
  ...
  constructor(private route: ActivatedRoute, private router: Router, private http: Http, private cdr: ChangeDetectorRef) {
    ...
    this.ApmBase.getHostInfo(this, "/apm/common");    // 获取产品线数据
    this.ApmBase.getOrderProdMaxRound(this,"tingyun_common");    // 应用变更频率top5
  }

  ngOnInit() {
    this.ApmBase.pagetion(this, "/apm/common");    // 分页
    this.ApmBase.handleCreateHost(this, "听云Common", "/apm/creatCommon");    // 创建应用
    this.ApmBase.handleDeleteHost(this, "/apm/dropCommon");    // 删除主应用
    this.ApmBase.searchHost(this, "/apm/common");    // 模糊搜索
    this.ApmBase.updateProducts(this, "/apm/updateCommon");    // 更新数据
